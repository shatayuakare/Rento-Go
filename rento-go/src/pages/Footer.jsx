                ...
                <footer className="bg-[#0E0C0B] text-zinc-100 sm:py-8 md:py-16 sm:px-8 md:px-16 lg:px-24 xl:px-28 md:flex justify-between h-auto min-h-auto">
                    <div className='md:w-[40%] sm:w-full'>
                        ...
                        <div className="flex gap-4 pt-10">
                            <Link className='btn btn-ghost hover:bg-transparent text-2xl  btn-circle hover:border-b-4 border-0 hover:border-red-500 bx-tada-hover' to="https://www.facebook.com" target="_blank" rel="noopener noreferrer">
                                <i className='bx bxl-facebook '></i>
                            </Link>
                            <Link className='btn btn-ghost hover:bg-transparent text-2xl btn-circle hover:border-b-4 border-0 hover:border-red-500 bx-tada-hover' to="https://www.instgram.com" target="_blank" rel="noopener noreferrer">
                                <i className='bx bxl-instagram'></i>
                            </Link>
                            <Link className='btn btn-ghost hover:bg-transparent text-2xl btn-circle hover:border-b-4 border-0 hover:border-red-500 bx-tada-hover' to="https://www.x.com" target="_blank" rel="noopener noreferrer">
                                <i className='bx bxl-twitter'></i>
                            </Link>
                            <Link className='btn btn-ghost hover:bg-transparent text-2xl btn-circle hover:border-b-4 border-0 hover:border-red-500 bx-tada-hover' to="https://www.linkedin.com" target="_blank" rel="noopener noreferrer">
